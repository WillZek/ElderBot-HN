...
// Staff De CrowBot
global.owner = [
   ['50493374445', 'Creador Elder🥷', true],
   ['50557865603', 'WillZek Soporte', true],
   ['50489513153', 'Posadas Soporte', true],
]

global.creadorbot = [
   ['50487421142', 'Elder', true],
]
...
global.nombrebot = '𝐇𝐍 𝐄𝐋𝐃𝐄𝐑 🤖'
global.textbot = `「 🔱 𝐄𝐥𝐝𝐞𝐫𝐁𝐨𝐭 - 𝐇𝐍 🔱 」`
global.vs = '1.0.0'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "543876577197-120363317332020195@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '👑【✫𝙷𝙽  乂 𝙴𝙻𝙳𝙴𝚁✫】🥷', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
